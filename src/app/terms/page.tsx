    ...
    <div className="container mx-auto p-4 md:p-8">
      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <p>Welcome to Lobasters ("we," "our," "us"). These Terms of Service ("Terms") govern your use of our local-first research application. By accessing or using our service, you agree to be bound by these Terms.</p>
          ...
          <h2>3. API Keys</h2>
          <p>Our service requires you to provide your own API keys for third-party Large Language Models (LLMs). You are solely responsible for the security and management of your API keys. We are not responsible for any loss or misuse of your API keys. Lobasters does not persist keys, but relays them with each model request to the provider you select.</p>
